...
| D10 | Sugerido de "Fijar presupuesto" (y de editar categoría) | **Cambia** (revisión de la fase 6): ya no es la suma de las recurrentes (`suggestCategoryMonthlyBudget`, retirada). Es el **promedio mensual de todo lo pagado en la categoría** — únicos y recurrentes — en los últimos 6 meses completos, contando solo desde el mes del primer gasto (`averageMonthlySpending`). Sin un mes completo de historia no hay sugerido. Motivo: el presupuesto de una categoría cubre todo lo que se registra en ella, sea recurrente o no. |
